...
__all__ = [
    'SAFT11kHz16BitMono', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechGrammarRuleState', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechRecoResult', 'SDKLCurrentUser',
    'SAFT8kHz16BitStereo', 'DISPID_SBSRead', 'DISPID_SGRSTWeight',
    'DISPID_SGRsCommitAndSave', 'SPEI_REQUEST_UI',
    'DISPID_SLGetWords', 'DISPID_SRSetPropertyNumber',
    'SpObjectTokenCategory', 'SPGS_DISABLED',
    'SpeechPropertyComplexResponseSpeed', 'SpeechAddRemoveWord',
    'DISPID_SRCRecognizer', 'SpeechRuleAttributes',
    'SPWT_PRONUNCIATION', 'SpeechTokenContext', 'SPRULE',
    'SGDSActiveUserDelimited', 'DISPID_SRSClsidEngine',
    'SAFTADPCM_8kHzMono', 'DISPID_SRSSupportedLanguages',
    'SP_VISEME_7', 'SPAR_High', 'ISpPhrase', 'SREStreamStart',
    'SAFT22kHz8BitStereo', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPRDisplayAttributes',
    'DISPID_SPPBRestorePhraseFromMemory', 'SGDSInactive', 'ISpAudio',
    'SPPS_LMA', 'SGSDisabled', 'ISpRecoResult', 'SRTSMLTimeout',
    'SpeechGrammarWordType', 'SRTExtendableParse',
    'SpeechRecoContextState', 'SPWT_LEXICAL',
    'DISPID_SPEEngineConfidence', 'SWTAdded', 'SPRS_ACTIVE',
    'ISpeechPhraseReplacements', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCState', 'DISPID_SLPsItem', 'DISPID_SRRGetXMLErrorInfo',
    'SVP_15', 'SAFTNonStandardFormat', 'SAFT22kHz8BitMono',
    'SPBO_AHEAD', 'SpSharedRecognizer', 'SpWaveFormatEx',
    'SpeechStreamSeekPositionType', 'DISPID_SVVoice',
    'DISPID_SRGIsPronounceable', 'SGDSActiveWithAutoPause',
    'IInternetSecurityMgrSite', 'ISpeechAudioBufferInfo',
    'ISpPhoneticAlphabetSelection', 'ISpeechLexiconPronunciation',
    'SP_VISEME_20', 'DISPID_SRCEHypothesis', 'DISPID_SRRGetXMLResult',
    'SpeechLoadOption', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVEVoiceChange', 'SECFEmulateResult', 'eLEXTYPE_PRIVATE1',
    'DISPID_SLAddPronunciationByPhoneIds', 'SDTAll', 'SITooFast',
    'SpPhoneticAlphabetConverter', 'ISpeechBaseStream',
    'SPAO_RETAIN_AUDIO', 'eLEXTYPE_VENDORLEXICON',
    'SAFT12kHz16BitStereo', 'ISpRecognizer',
    'DISPID_SRGSetTextSelection', 'SpResourceManager',
    'SREStateChange', 'DISPID_SWFEBitsPerSample', 'STCInprocHandler',
    'SAFTText', 'SDTRule', 'SVSFVoiceMask',
    'DISPID_SpeechObjectToken',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpShortcut',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpLexicon',
    'DISPID_SLWType', 'ISpeechObjectTokens', 'SpeechAllElements',
    'SpMemoryStream', 'SPDKL_CurrentConfig', 'SPSLMA',
    'SAFT32kHz8BitStereo', 'DISPID_SpeechPhraseRule', 'SVP_1',
    'SAFT32kHz16BitMono', 'SGRSTTDictation', 'SPINTERFERENCE_TOOLOUD',
    'SECHighConfidence', 'DISPID_SPPFirstElement',
    'SPEI_WORD_BOUNDARY', 'ISpeechLexiconWords', 'ISpNotifySource',
    'SDKLCurrentConfig', 'SVP_6', 'DISPID_SpeechPhraseElements',
    'DISPID_SLWWord', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'eLEXTYPE_RESERVED7', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SWFEBlockAlign', 'DISPID_SRRPhraseInfo', 'SVPOver',
    'SREAdaptation', 'DISPIDSPTSI_SelectionOffset', 'SITooSlow',
    'SPGRAMMARSTATE', 'DISPID_SRCEStartStream', 'SAFT32kHz8BitMono',
    'DISPID_SRRecognizer', 'SAFT11kHz8BitMono', 'SVSFIsNotXML',
    'SpeechCategoryAudioIn', 'DISPID_SRCPause', 'SRADynamic',
    'SPFM_CREATE', 'ISpeechGrammarRuleStateTransitions',
    'SpeechVoiceSpeakFlags', 'SPEI_START_INPUT_STREAM',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVEventInterests', 'SP_VISEME_19',
    'SPPS_RESERVED2', 'ISpMMSysAudio', 'SpeechDisplayAttributes',
    'ISpObjectToken', 'DISPID_SASetState', 'SPAS_RUN',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRCreateRecoContext',
    'DISPID_SVDisplayUI', 'ISpeechPhoneConverter',
    'ISpNotifyTranslator', 'SPEI_SR_RETAINEDAUDIO', 'SVSFIsFilename',
    'SWTDeleted', 'DISPID_SPELexicalForm', 'SAFT22kHz16BitStereo',
    'ISpeechObjectToken', 'DISPID_SRIsShared', 'DISPID_SVRate',
    'DISPID_SVGetProfiles', 'DISPID_SRSetPropertyString',
    'ISpeechObjectTokenCategory', 'SpeechRegistryUserRoot',
    'STSF_LocalAppData', 'SPFM_NUM_MODES', 'SPEI_RESERVED6',
    'SpObjectToken', 'DISPID_SRGCmdLoadFromFile', 'SPVOICESTATUS',
    'eLEXTYPE_PRIVATE18', 'SAFT24kHz8BitStereo',
    'DISPID_SPAPhraseInfo', 'DISPID_SRCEInterference',
    'DISPID_SPRuleParent', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SOTRemove', 'DISPID_SVSInputWordPosition',
    'eLEXTYPE_RESERVED4', 'SPXRO_Alternates_SML',
    'ISpeechAudioFormat', 'SpeechRuleState', 'DISPID_SOTCSetId',
    'DISPID_SRSAudioStatus', 'DISPID_SPAsItem',
    'DISPID_SRCRetainedAudio', 'SPRECORESULTTIMES',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechPhoneConverter',
    '_ISpeechRecoContextEvents', 'ISpRecognizer2',
    'DISPID_SLGenerationId', 'DISPID_SRStatus', 'ISpeechLexicon',
    'DISPID_SVSRunningState', 'DISPID_SVEEnginePrivate',
    'DISPID_SPRsItem', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SABIMinNotification', 'DISPID_SPEActualConfidence',
    'SP_VISEME_0', 'eLEXTYPE_PRIVATE19', 'SpInprocRecognizer',
    'SRSInactive', 'SPEI_MAX_SR', 'DISPID_SpeechRecognizerStatus',
    'SREPrivate', 'DISPID_SLGetPronunciations', 'DISPID_SWFEChannels',
    'DISPID_SFSOpen', 'SVP_10', 'SRSActive', 'SRAImport',
    'ISpeechPhraseProperties', 'DISPID_SVVolume', 'SREAllEvents',
    'SAFT32kHz16BitStereo', 'DISPID_SOTDataKey',
    'DISPID_SASCurrentDevicePosition',
    'DISPID_SRGSetWordSequenceData', 'ISpStream',
    'SPWORDPRONOUNCEABLE', 'SPCT_SUB_DICTATION', 'SPPROPERTYINFO',
    'eLEXTYPE_PRIVATE6', 'STSF_FlagCreate',
    'DISPID_SpeechRecoResult2', 'SSFMOpenForRead', 'SPEI_SOUND_START',
    'SRTAutopause', 'SAFT48kHz16BitStereo', 'SPRECOSTATE',
    'DISPID_SRRRecoContext', 'STCLocalServer', 'ISpRecoGrammar2',
    'SPWORDTYPE', 'DISPID_SOTsItem', 'SPPS_RESERVED4',
    'SpeechRecoProfileProperties', 'SRSActiveAlways',
    'DISPID_SOTMatchesAttributes', 'DISPID_SABufferNotifySize',
    'SVEVoiceChange', 'SPWORD', 'DISPID_SRCEPropertyNumberChange',
    '_RemotableHandle', 'SVSFPersistXML', 'DISPID_SRCRequestedUIType',
    'SpeechEngineConfidence', 'DISPID_SPRuleFirstElement',
    'SREStreamEnd', 'tagSTATSTG', 'SPEI_SR_PRIVATE',
    'DISPID_SRGReset', 'SpeechBookmarkOptions', 'SpPhraseInfoBuilder',
    'DISPID_SPEsCount', 'SGSExclusive', 'DISPID_SPIAudioSizeBytes',
    'SVSFPurgeBeforeSpeak', 'SPPS_RESERVED3', 'SPVPRIORITY',
    'DISPID_SPIEngineId', 'SVPNormal', 'ISpeechPhraseInfo',
    'DISPID_SRRTOffsetFromStart', 'SPAS_STOP', 'SPCT_DICTATION',
    'SVP_14', 'STSF_CommonAppData', 'DISPID_SDKEnumValues',
    ...
    'DISPID_SVIsUISupported', 'SPSMF_SRGS_SAPIPROPERTIES', 'SBOPause',
    'DISPID_SPRsCount', 'SREPhraseStart', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SGRId',
    'SPINTERFERENCE_TOOQUIET',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechAudioFormat', 'DISPID_SLPLangId',
    'DISPID_SLPSymbolic', 'SGDisplay', 'DISPID_SVSInputWordLength',
    'SRERecoOtherContext', 'DISPID_SRRTTickCount', 'SRESoundStart',
    'SPCT_SLEEP', 'DISPID_SADefaultFormat', '_ISpeechVoiceEvents',
    'SVP_8', 'SPAUDIOOPTIONS', 'SPSERIALIZEDPHRASE',
    'eLEXTYPE_PRIVATE5', 'SITooQuiet', 'SDKLLocalMachine', 'SVF_None',
    'SPEI_SR_AUDIO_LEVEL', 'ISpeechRecoResultTimes',
    'DISPID_SpeechDataKey', 'ISpeechRecoResultDispatch', 'SVP_20',
    'DISPIDSPTSI', 'SpStreamFormatConverter', 'SRATopLevel',
    'SVPAlert', 'SDTAlternates', 'SPSHORTCUTTYPE',
    'SpeechPartOfSpeech', 'DISPID_SpeechPhraseBuilder', 'DISPIDSPRG',
    'SAFT16kHz16BitStereo', 'SRTReSent', 'DISPID_SDKOpenKey',
    'DISPID_SPRuleId', 'DISPID_SpeechObjectTokenCategory',
    'ISpEventSource', 'DISPID_SABufferInfo', 'DISPID_SPPsCount',
    'eLEXTYPE_RESERVED10', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SREmulateRecognition', 'SpVoice',
    'DISPID_SRGetPropertyString', 'SPWORDLIST', 'SVP_12',
    'ISpStreamFormat', 'DISPID_SPRules_NewEnum', 'ISpRecoContext2',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SMSGetData',
    'DISPID_SAFType', 'DISPID_SGRInitialState', 'SVP_16',
    'DISPID_SpeechRecognizer', 'SpeechSpecialTransitionType',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SpeechGrammarRule', 'DISPID_SPIAudioSizeTime',
    'ISpXMLRecoResult', 'DISPID_SLPsCount', 'ISpNotifySink',
    'SSFMCreate', 'ISpeechMMSysAudio', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SGRAttributes', 'SBONone', 'SPPS_NotOverriden',
    'eLEXTYPE_RESERVED9', 'SVP_19', 'SECLowConfidence',
    'SPEI_SR_BOOKMARK', 'SWPUnknownWordUnpronounceable',
    'Speech_Default_Weight', 'DISPID_SRDisplayUI',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SVPriority',
    'SDA_Two_Trailing_Spaces', 'SPWF_SRENGINE', 'SAFT24kHz8BitMono',
    'eLEXTYPE_USER', 'eLEXTYPE_LETTERTOSOUND',
    'SpeechPropertyResourceUsage', 'SAFTDefault', 'SPEI_RESERVED5',
    'SVEStartInputStream', 'SPPHRASE', 'DISPID_SGRSRule',
    'DISPID_SDKDeleteValue', 'SPEVENTENUM', 'DISPID_SLWsItem',
    'ISpPhoneticAlphabetConverter', 'ISpeechPhraseRules',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPIGetDisplayAttributes',
    'SSSPTRelativeToEnd', 'SpeechInterference', 'SVSFlagsAsync',
    'SAFTCCITT_uLaw_8kHzMono', 'SVP_3', 'DISPID_SGRSTsItem',
    'DISPID_SCSBaseStream', 'eLEXTYPE_PRIVATE17',
    'ISpeechPhraseReplacement', 'SPVPRI_NORMAL',
    'DISPID_SLGetGenerationChange', 'SSTTDictation',
    'DISPID_SpeechVoiceStatus', 'SpeechTokenKeyUI',
    'DISPID_SGRsCount', 'DISPID_SRCSetAdaptationData', 'SSTTWildcard',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRCESoundEnd',
    'DISPID_SRCEPhraseStart', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SAFTADPCM_44kHzMono', 'SRESoundEnd', 'SVSFUnusedFlags',
    'ISpeechAudio', 'SGDSActive', 'SDA_One_Trailing_Space',
    'SGLexical', 'DISPID_SRCERecognition',
    'DISPID_SpeechLexiconWords', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFT16kHz8BitMono', 'DISPID_SLWsCount',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPSNotOverriden',
    'DISPID_SPIEnginePrivateData', 'SPVISEMES', 'SpAudioFormat',
    'SpeechTokenKeyAttributes', 'SAFTCCITT_ALaw_8kHzMono',
    'SPRST_ACTIVE', 'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SVResume',
    'SpCompressedLexicon', 'DISPID_SpeechAudioStatus',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPPId',
    'DISPID_SVSVisemeId', 'SPEI_RECO_STATE_CHANGE', 'SPPHRASEELEMENT',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRGCmdSetRuleState',
    'SPLO_STATIC', 'eWORDTYPE_ADDED', 'DISPID_SWFESamplesPerSec',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPSHORTCUTPAIR',
    'SpeechVoicePriority', 'SpeechCategoryAudioOut',
    'DISPID_SpeechBaseStream', 'DISPID_SVEBookmark', 'SPEI_RESERVED3',
    'WAVEFORMATEX', 'SSFMCreateForWrite', 'ISpEventSink',
    'DISPID_SOTCGetDataKey', 'SpeechGrammarTagDictation',
    'DISPID_SGRSTransitions', 'SP_VISEME_8',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SDKEnumKeys',
    'SSSPTRelativeToStart', 'DISPID_SGRsAdd', 'DISPID_SLPPhoneIds',
    'SpeechAudioProperties', 'SAFTTrueSpeech_8kHz1BitMono',
    'SP_VISEME_21', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SOTCreateInstance', 'SPCS_DISABLED', 'DISPID_SRCBookmark',
    'DISPID_SpeechRecoContextEvents', 'SVEAllEvents',
    'SPEI_RECOGNITION', 'DISPID_SDKSetStringValue',
    'DISPID_SPRs_NewEnum', 'DISPID_SRGCmdLoadFromResource',
    'SDTProperty', 'eLEXTYPE_PRIVATE16', 'DISPID_SPEAudioSizeBytes',
    'SECFIgnoreKanaType', 'SVSFNLPSpeakPunc',
    'DISPID_SASNonBlockingIO', 'SPRECOGNIZERSTATUS',
    'SpNullPhoneConverter', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SPWORDPRONUNCIATIONLIST', 'ISpeechRecoResult',
    'SPSEMANTICERRORINFO', 'SpStream', '_SPAUDIOSTATE',
    'DISPID_SRGDictationSetState', 'DISPID_SPRuleNumberOfElements',
    'SPBOOKMARKOPTIONS', 'ISequentialStream',
    'DISPID_SRCERecognizerStateChange', 'SPAUDIOBUFFERINFO',
    'SPAUDIOSTATUS', 'SPBO_TIME_UNITS', 'ISpeechRecognizerStatus',
    'ISpeechRecoGrammar', 'DISPID_SGRsCommit', 'DISPID_SpeechVoice',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SOTGetDescription',
    'eLEXTYPE_APP', 'SpeechLexiconType', 'DISPID_SPACommit',
    'DISPID_SRGetPropertyNumber', '__MIDL_IWinTypes_0009',
    'SPAR_Unknown', 'DISPID_SFSClose', 'DISPID_SOTId',
    'SPPS_Function', 'ISpRecoGrammar', 'SVP_17',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRGCmdLoadFromObject',
    'SASStop', 'SpeechCategoryRecognizers', 'SPDKL_LocalMachine',
    'SPEI_END_SR_STREAM', 'DISPIDSPTSI_SelectionLength',
    'SDTReplacement', 'SASClosed', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SPEI_FALSE_RECOGNITION', 'SAFTCCITT_ALaw_11kHzMono',
    'SREBookmark', 'DISPID_SPCPhoneToId', 'DISPID_SPCIdToPhone',
    'SAFTGSM610_44kHzMono', 'SDTPronunciation', 'SVSFNLPMask',
    'SPSERIALIZEDRESULT', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SGRSTPropertyId', 'SREHypothesis', 'SPPHRASERULE',
    'SP_VISEME_12', 'IInternetSecurityManager', 'DISPID_SRGetFormat',
    'DISPID_SRCEEndStream', 'SPEI_MIN_TTS', 'eLEXTYPE_PRIVATE3',
    'SGRSTTRule', 'DISPID_SRGState', 'SPSFunction', 'SRERecognition',
    'SpeechRetainedAudioOptions', 'eLEXTYPE_PRIVATE7',
    'Speech_Max_Pron_Length', 'SAFT11kHz8BitStereo', 'SPSMF_UPS',
    'DISPID_SGRSTNextState', 'SAFT48kHz8BitMono',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechMemoryStream',
    'SRAExport', 'SPEI_PHRASE_START', 'DISPID_SPPName',
    'SRSEIsSpeaking', 'SINone', 'DISPID_SOTSetId', 'SPEI_UNDEFINED',
    'SPVPRI_OVER', 'DISPID_SVEStreamEnd', 'SVEPhoneme',
    'SpeechEngineProperties', 'SPEI_PHONEME', 'DISPID_SMSALineId',
    'SRCS_Disabled', 'SPFM_CREATE_ALWAYS', 'SpFileStream',
    'DISPID_SOTCDefault', 'DISPID_SVAlertBoundary',
    'DISPID_SGRAddState', 'DISPID_SpeechPhraseProperty',
    'DISPID_SGRs_NewEnum', 'DISPID_SVSkip', 'SPEI_RECO_OTHER_CONTEXT',
    'SPSEMANTICFORMAT', 'SpeechDictationTopicSpelling',
    'SPINTERFERENCE_NOSIGNAL', 'SP_VISEME_5', 'DISPID_SWFEExtraData',
    'DISPID_SPPEngineConfidence', 'SPPARTOFSPEECH',
    'eLEXTYPE_RESERVED8', 'SREAudioLevel', 'SPRST_INACTIVE',
    'SPEI_HYPOTHESIS', 'SPBO_PAUSE', 'SpeechUserTraining',
    'SP_VISEME_9', 'SPEI_START_SR_STREAM', 'SVSFParseSsml',
    'ISpeechFileStream', 'SP_VISEME_2', 'SRADefaultToActive',
    'SPFM_OPEN_READWRITE', 'SPPS_Verb', 'SpMMAudioOut',
    'SpeechPropertyResponseSpeed', 'ISpeechResourceLoader',
    'SFTSREngine', 'SAFTADPCM_22kHzMono', 'DISPID_SDKSetBinaryValue',
    'DISPID_SGRSTRule', 'ISpeechGrammarRuleState',
    'DISPID_SpeechWaveFormatEx', 'SGSEnabled',
    'DISPID_SGRSTs_NewEnum', 'SECNormalConfidence',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRGDictationUnload',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRsFindRule',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRsItem', 'SAFT12kHz8BitMono',
    'SPSSuppressWord', 'DISPID_SAFGuid', 'Speech_StreamPos_RealTime',
    'SGRSTTTextBuffer', 'SPEI_RESERVED2', 'SVP_11', 'DISPID_SVSpeak',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPPs_NewEnum',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRIsUISupported',
    'SLOStatic', 'DISPID_SBSWrite', 'Speech_StreamPos_Asap',
    'SPCS_ENABLED', 'DISPID_SOTIsUISupported',
    'DISPID_SLPPartOfSpeech', 'DISPID_SpeechXMLRecoResult',
    'SREPropertyStringChange', 'DISPID_SpeechGrammarRules',
    'DISPID_SVEWord', 'DISPID_SpeechLexicon', 'DISPID_SRGRecoContext',
    'DISPID_SRCRetainedAudioFormat', 'SLTUser',
    'SpeechTokenIdUserLexicon', 'SpeechTokenValueCLSID',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRCESoundStart',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPRuleChildren',
    'ISpeechPhraseElements', 'SpTextSelectionInformation',
    'DISPID_SBSSeek', 'DISPID_SRCVoicePurgeEvent', 'DISPID_SPCLangId',
    'DISPID_SLAddPronunciation', 'SAFT44kHz16BitStereo',
    'DISPID_SABIBufferSize', 'SWPKnownWordPronounceable',
    'DISPID_SVAudioOutputStream', 'SPSVerb',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPDKL_CurrentUser', 'DISPID_SRRTLength', 'UINT_PTR',
    'SPPS_Unknown', 'DISPID_SVSLastStreamNumberQueued',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpGrammarBuilder',
    'SWPUnknownWordPronounceable', 'SLODynamic', 'SP_VISEME_14',
    'ISpeechRecognizer', 'DISPID_SpeechObjectTokens',
    'ISpPhoneConverter', 'SPRST_NUM_STATES', 'SpPhoneConverter',
    'DISPID_SPIGrammarId', 'DISPID_SRCAudioInInterferenceStatus',
    'SpeechAudioFormatGUIDWave', 'DISPID_SDKDeleteKey', 'IEnumString',
    'SVEEndInputStream', 'SDKLDefaultLocation', 'SPEI_MIN_SR',
    'SpeechWordType', 'eLEXTYPE_MORPHOLOGY',
    'ISpeechPhraseAlternates', 'DISPID_SRCEBookmark',
    'SAFT8kHz8BitMono', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVWaitUntilDone', 'SRCS_Enabled',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPAs_NewEnum',
    'SpeechAudioFormatGUIDText', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPEI_RESERVED1', 'DISPID_SWFEFormatTag', 'DISPID_SPIProperties',
    'DISPID_SVSpeakCompleteEvent', 'SPSHT_NotOverriden',
    'eLEXTYPE_PRIVATE2', 'DISPID_SpeechCustomStream',
    'DISPID_SRCERequestUI', 'SAFTCCITT_uLaw_22kHzMono',
    'SGRSTTEpsilon', 'DISPID_SPRuleConfidence',
    'DISPID_SPRFirstElement', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SpeechAudio', 'SPAR_Medium', 'SPRULESTATE',
    'SPINTERFERENCE', 'SPSHT_Unknown', 'ISpeechPhraseRule',
    'DISPID_SVEStreamStart', 'SPCATEGORYTYPE', 'SRSEDone',
    'DISPID_SPRuleName', 'SVP_18', 'DISPID_SPPParent',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPPS_Modifier',
    'SSSPTRelativeToCurrentPosition', 'SP_VISEME_11',
    'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE13',
    'SVSFParseAutodetect', 'SINoSignal', 'SPPS_SuppressWord',
    'SP_VISEME_4', 'ISpeechRecoContext', 'SDA_No_Trailing_Space',
    'eLEXTYPE_PRIVATE10', 'SDTLexicalForm', 'SpLexicon',
    'ISpeechVoiceStatus', 'DISPID_SRGCmdLoadFromMemory',
    'SPRST_INACTIVE_WITH_PURGE', 'SFTInput', 'SRAONone',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechPhraseAlternates',
    'STCAll', 'DISPID_SLRemovePronunciation', 'DISPID_SVGetVoices',
    'DISPID_SRRAlternates', 'SPEI_INTERFERENCE',
    'SAFTADPCM_11kHzMono', 'SpeechDiscardType',
    'DISPID_SpeechPhraseElement', 'SpMMAudioEnum', 'IStream',
    'DISPID_SPISaveToMemory', 'DISPID_SPEs_NewEnum',
    'SPINTERFERENCE_TOOFAST', 'SVF_Emphasis', 'SAFTADPCM_44kHzStereo',
    'DISPID_SGRSAddWordTransition', 'SpeechRunState',
    'SAFT48kHz16BitMono', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SPEsItem', 'SRTEmulated', 'ISpeechRecoResult2',
    'SpeechVoiceSkipTypeSentence', 'SPFILEMODE', 'SASPause',
    'SVESentenceBoundary', 'DISPID_SPERequiredConfidence',
    'DISPID_SRCEAdaptation', 'SVP_7', 'SVP_5', 'SPGRAMMARWORDTYPE',
    'DISPID_SPIRule', 'DISPID_SpeechPhraseInfo',
    'DISPID_SLWPronunciations', 'eLEXTYPE_RESERVED6', 'SPBO_NONE',
    'SPPS_Noun', 'SPDKL_DefaultLocation', 'SECFIgnoreCase',
    'DISPID_SDKSetLongValue', 'DISPID_SRCEventInterests',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPEI_VISEME',
    'ISpStreamFormatConverter', 'SVEPrivate', 'SDTDisplayText',
    'SpeechMicTraining', 'SAFT16kHz8BitStereo', 'SVP_9', 'SVP_4',
    'DISPID_SRAudioInputStream', 'SpSharedRecoContext', 'SGRSTTWord',
    'SpShortcut', 'SSFMOpenReadWrite', 'DISPID_SLWs_NewEnum',
    'SPEI_SENTENCE_BOUNDARY', 'ISpeechTextSelectionInformation',
    'SPFM_OPEN_READONLY', 'SVP_0', 'DISPID_SOTDisplayUI',
    'SPSMF_SAPI_PROPERTIES', 'SPEI_VOICE_CHANGE',
    'SAFTCCITT_ALaw_44kHzMono', 'SPDATAKEYLOCATION', 'DISPID_SVPause',
    'SPADAPTATIONRELEVANCE', 'ISpResourceManager',
    'tagSPPROPERTYINFO', 'DISPID_SDKGetBinaryValue',
    'eLEXTYPE_PRIVATE12', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SAStatus', 'DISPID_SVStatus', 'SAFT22kHz16BitMono',
    'SpMMAudioIn', 'SP_VISEME_6', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRRTimes', 'DISPID_SMSADeviceId', 'DISPID_SLWLangId',
    'SASRun', 'SAFT44kHz8BitStereo', 'DISPID_SRProfile',
    'DISPID_SRRAudioFormat', 'ISpProperties', 'SP_VISEME_17',
    'SINoise', 'DISPID_SRRSetTextFeedback', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechVoiceEvent', 'SVSFIsXML', 'SAFT8kHz8BitStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SGRSTTWildcard',
    'SP_VISEME_16', 'DISPID_SGRSAddSpecialTransition',
    'SpeechAudioFormatType', 'SpeechVisemeFeature', 'DISPID_SRGId',
    'eWORDTYPE_DELETED', 'DISPID_SPAStartElementInResult',
    'DISPID_SPRulesCount', 'SAFTNoAssignedFormat',
    'DISPID_SRCCreateGrammar', 'DISPID_SRRTStreamTime',
    'SAFT16kHz16BitMono', 'DISPID_SVSPhonemeId', 'DISPID_SRState',
    'DISPID_SpeechPhraseRules', 'ISpeechPhraseElement',
    'SpeechCategoryPhoneConverters',
    'SpeechGrammarTagUnlimitedDictation', 'SGLexicalNoSpecialChars',
    'DISPID_SRRSaveToMemory', 'SpInProcRecoContext', 'LONG_PTR',
    'ISpeechLexiconWord', 'DISPID_SVSLastResult',
    'DISPID_SRGetRecognizers', 'SECFNoSpecialChars', 'SPAS_CLOSED',
    'DISPID_SPRText', 'DISPID_SPPChildren', 'SPLEXICONTYPE',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVEViseme',
    'SPINTERFERENCE_TOOSLOW', 'ISpVoice', 'SPBINARYGRAMMAR',
    'DISPID_SpeechPhraseReplacements', 'ISpRecoCategory',
    'SAFT8kHz16BitMono', 'DISPID_SpeechLexiconProns',
    'SPEI_SOUND_END', 'SpUnCompressedLexicon', 'DISPID_SGRsDynamic',
    'DISPID_SGRSTsCount', 'SAFT48kHz8BitStereo', 'STCInprocServer',
    'SDA_Consume_Leading_Spaces', 'DISPID_SLPs_NewEnum',
    'SAFTCCITT_uLaw_44kHzMono', 'SVEViseme', 'DISPID_SPPsItem',
    'ISpeechVoice', 'DISPID_SpeechFileStream',
    'SpeechWordPronounceable', 'DISPID_SAEventHandle',
    'DISPID_SRGDictationLoad', 'SGPronounciation',
    'DISPIDSPTSI_ActiveLength', 'SDTAudio', 'DISPID_SRRAudio',
    'ISpeechGrammarRules', 'ISpeechAudioStatus', 'SPAR_Low',
    'DISPID_SRGCommit', 'DISPID_SVGetAudioInputs',
    'DISPID_SPRNumberOfElements', 'SpeechPropertyAdaptationOn',
    'SLTApp', 'SPRST_ACTIVE_ALWAYS', 'SPEI_MAX_TTS',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRSCurrentStreamPosition', 'SAFT11kHz16BitStereo',
    'SVEAudioLevel', 'SP_VISEME_18', 'SPPHRASEPROPERTY',
    'SPPHRASEREPLACEMENT', 'SRSInactiveWithPurge',
    'DISPID_SGRSTPropertyName', 'DISPID_SPILanguageId',
    'DISPID_SGRAddResource', 'SPVPRI_ALERT', 'eLEXTYPE_PRIVATE14',
    'SECFDefault', 'DISPID_SPAsCount', 'SP_VISEME_13',
    'SRAORetainAudio', 'SPPS_RESERVED1', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT12kHz8BitStereo', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SRTStandard',
    'SPINTERFERENCE_NONE', 'DISPID_SPIElements',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechGrammarTagWildcard', 'SpeechVisemeType',
    'DISPID_SPIStartTime', 'DISPID_SPEAudioStreamOffset',
    'SPGS_ENABLED', 'DISPID_SpeechRecoContext',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPIGetText', 'SPSUnknown',
    'DISPID_SGRName', 'SPEI_PROPERTY_NUM_CHANGE', 'SP_VISEME_3',
    ...
    'IEnumSpObjectTokens', 'DISPID_SRRSpeakAudio', 'SVP_21', 'SVP_2',
    'DISPID_SMSSetData', 'DISPID_SRGRules', 'SPEVENT',
    'DISPID_SVSLastBookmarkId', 'SVSFParseSapi', 'SPWAVEFORMATTYPE',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVESentenceBoundary',
    'SPEI_ADAPTATION', 'SpeechAudioVolume', 'SAFT24kHz16BitStereo',
    'DISPID_SBSFormat', 'DISPID_SASState', 'SPWT_DISPLAY',
    'SPAS_PAUSE', 'SPRS_INACTIVE', 'SpeechRecoEvents',
    'SPEI_END_INPUT_STREAM', 'SPLOADOPTIONS', 'SPSModifier',
    'SRAInterpreter', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRCEPropertyStringChange', 'SAFTCCITT_ALaw_22kHzMono',
    'SPEI_TTS_PRIVATE', 'SP_VISEME_1', 'SECFIgnoreWidth',
    'DISPID_SVSInputSentencePosition', 'SpeechEmulationCompareFlags',
    'SpeechCategoryAppLexicons', 'SPCT_SUB_COMMAND',
    'DISPID_SABIEventBias', 'SAFTGSM610_22kHzMono', 'SVP_13',
    'SPLO_DYNAMIC', 'SVSFParseMask', 'SPWF_INPUT',
    'DISPID_SVEPhoneme', 'ISpeechPhraseAlternate',
    'SpeechTokenKeyFiles', 'DISPID_SVSpeakStream', 'SPSHT_OTHER',
    'SVEWordBoundary', 'DISPID_SGRSTType', 'SRARoot',
    'DISPID_SPPConfidence', 'ISpSerializeState',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SOTsCount',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SGRSTPropertyValue',
    'DISPID_SOTs_NewEnum', 'SPSTREAMFORMATTYPE', 'SpeechVoiceEvents',
    'ISpeechDataKey', 'SPTEXTSELECTIONINFO', 'SP_VISEME_15',
    'SREPropertyNumChange', 'ISpRecoContext', 'SpeechDataKeyLocation',
    'ISpeechGrammarRuleStateTransition', 'SAFT44kHz8BitMono',
    'DISPID_SOTCategory', 'DISPID_SPEAudioSizeTime',
    'SpeechAudioState', 'DISPID_SGRSTText', 'SpCustomStream',
    'SPWORDPRONUNCIATION', 'SAFT24kHz16BitMono',
    'ISpeechCustomStream', 'SpeechGrammarState', 'SPEVENTSOURCEINFO',
    'DISPID_SPPNumberOfElements', 'ISpeechLexiconPronunciations',
    'SPCT_COMMAND', 'ISpeechGrammarRule', 'DISPID_SAVolume',
    'DISPID_SOTCId', 'DISPID_SPEPronunciation',
    'SAFTCCITT_uLaw_11kHzMono', 'SPCONTEXTSTATE',
    'SpeechCategoryRecoProfiles', 'DISPID_SPEDisplayText',
    'SpeechRecognitionType', 'SREInterference', 'eLEXTYPE_PRIVATE9',
    'ISpeechMemoryStream', 'DISPID_SPRulesItem',
    'SPINTERFERENCE_NOISE', 'ISpDataKey', 'eLEXTYPE_PRIVATE4',
    'DISPID_SMSAMMHandle', 'SRERequestUI', 'ISpRecognizer3',
    'eLEXTYPE_PRIVATE20', 'SPPS_Interjection', 'SPPS_Noncontent',
    'DISPID_SPARecoResult', 'SPAUDIOSTATE', 'SPAO_NONE',
    'DISPID_SRCVoice', 'DISPID_SVSLastBookmark', 'SPXMLRESULTOPTIONS',
    ...
    'DISPID_SLPType', 'SPEI_TTS_BOOKMARK', 'SpeechFormatType',
    'SPXRO_SML', 'DISPID_SVGetAudioOutputs', 'ISpeechXMLRecoResult',
    'SVF_Stressed', 'SpeechRegistryLocalMachineRoot',
    'ISpObjectTokenCategory', 'ISpPhraseAlt', 'SAFT44kHz16BitMono',
    'STCRemoteServer', 'ISpeechPhraseProperty',
    'SAFTExtendedAudioFormat', 'STSF_AppData', 'DISPID_SRAudioInput',
    'SpNotifyTranslator', 'DISPID_SGRClear', 'SITooLoud',
    'DISPID_SpeechAudioBufferInfo', 'ISpObjectWithToken',
    'SVEBookmark', 'DISPID_SRCResume', 'SpeechRecognizerState',
    'SP_VISEME_10', 'DISPID_SPPValue', 'DISPID_SDKGetStringValue',
    'SpeechStreamFileMode', 'DISPID_SpeechPhraseAlternate',
    'SPSHT_EMAIL', 'DISPID_SVAudioOutput', 'SPSInterjection',
    'SPSNoun', 'SSTTTextBuffer'
]

_check_version('1.2.0', 1701164706.206822)
